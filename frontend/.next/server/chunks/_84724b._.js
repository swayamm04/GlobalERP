...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        if (email === "admin@metalindustries.com" && password === "vasantha") {
            // Set auth cookie
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("auth_token", "valid_token", {
                expires: 1
            }); // Expires in 1 day
