            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden sm:table-cell text-right">Total Business</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {loading ? (
                  ...
                  filteredCustomers.map((customer) => (
                    <TableRow key={customer._id} className="hover:bg-muted/50 transition-colors">
                      ...
                      <TableCell className="font-bold text-right hidden sm:table-cell text-primary">
